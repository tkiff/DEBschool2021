...
% time-length for the upper damariscotta River (tL1)
...
% Estimations TL1 and TL2 without varying temperature 
  % Time vs. shell length the upper damariscotta River (tL1)
...
%   ELw1  = [L_bj; L_ji];                                             % cm,  expected physical length at time 
    % Time vs. shell length the upper damariscotta River (tL1)
...
function dL = get_L1(t, L, L_j, L_i, r_j, r_B, T_ref, T_A)
...
function dL = get_L2(t, L, L_j, L_i, r_j, r_B, T_ref, T_A)
